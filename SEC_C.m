...
function [ccc_sum]=SEC_C(data,templates,k,moveouts,weights)
    ...
    for j=1:n_s %loop over stations
        for jj=1:n_c %loop over componets
            ...
            for i=1:n_t %number of templates
                ...
                %channel and templates comment out the above statement and uncomment below;
                %you should give a directory ("your_directory_") for saving the CCCs.
                
                %save(['yourdirectory_/CCC_',num2strt(j),'_',num2str(jj),...
